...
export default class _iFile extends _iBase {
     ...
     */
    private static _elmToBox(elm: HTMLElement | JQuery): JQuery {
        return $(elm).closest('.xi-box');
    }
    
    //get file object
    private static _elmToFile(elm: HTMLElement | JQuery): JQuery {
        return _iFile._boxGetFile(_iFile._elmToBox(elm));
    }
    
    //get input object
    private static _elmToObj(elm: HTMLElement | JQuery): JQuery {
        return _iFile._boxGetObj(_iFile._elmToBox(elm));
    }
    
    //get link object
    private static _elmToLink(elm: HTMLElement | JQuery): JQuery {
