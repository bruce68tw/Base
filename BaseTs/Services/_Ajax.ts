import ErrorRowDto from '../Models/ErrorRowDto';
import ResultDto from '../Models/ResultDto';
import AjaxDto from '../Models/AjaxDto';
...
export default class _Ajax {
     ...
     */
    static async getFileA(url: string, data: any, elm?: HTMLElement | null, fnOk?: (res: any) => void): Promise<void> {
