...
export default class _iHtml extends _iBase {
    ...
    static init(edit: any, prog: string, height?: number): void {
        edit.eform.find(_iHtml.Filter).each(function (this: HTMLElement) {
            const upMe = $(this);
            ...
            upMe.summernote({
                ...
                callbacks: {
                    ...
                    */
                    ...
                    onChange: function (this: HTMLElement, contents: string, $editable: JQuery) {
                    ...
                    onImageUpload: function (this: HTMLElement, files: FileList) {
